...
struct Renderer::Impl
{
    ...
    VkDescriptorSetLayout& m3MaterialLayout = pipelines.m3MaterialLayout;
    VkDescriptorSetLayout& m3LightingLayout = pipelines.m3LightingLayout;
    VkDescriptorSetLayout& m3TaaLayout = pipelines.m3TaaLayout;
    VkDescriptorSetLayout& m3ClusterLayout = pipelines.m3ClusterLayout;
    VkDescriptorSetLayout& m3TonemapLayout = pipelines.m3TonemapLayout;
    ...
    void cleanupM3Descriptors() noexcept
    {
        ...
        pipelines.destroyM3Layouts(device);
    ...
    VkBuffer screenshotReadback)
{
    ...
    ctx.m3FrameResources = &m3FrameResources;
    ctx.frameContext = &frameContext;
    ctx.debugReadbacks = &debugReadbacks;
    ctx.gpuAllocator = &gpuAllocator;
    ctx.descriptorPool = m3DescriptorPool;
    ctx.linearSampler = m3LinearSampler;
