...
void M3PassContext::setError(std::string message)
{
...
VkDescriptorSet M3PassContext::allocateSet(VkDescriptorSetLayout layout)
{
...
void M3PassContext::writeSampled(
    VkDescriptorSet set,
...
void M3PassContext::writeSampler(VkDescriptorSet set)
{
...
void M3PassContext::writeStorage(VkDescriptorSet set, std::uint32_t binding, VkImageView view)
{
...
void M3PassContext::writeStorageBuffer(
...
void M3PassContext::writeUniformBuffer(
    VkDescriptorSet set, std::uint32_t binding, VkBuffer buffer, VkDeviceSize size)
{
    VkDescriptorBufferInfo info{buffer, 0, size};
    VkWriteDescriptorSet write{};
...
void M3PassContext::writeGpuStageTimestamp(std::uint32_t stage, bool begin)
{
...
void M3PassContext::transitionImage(
    VkImage image,
...
Halcyon::Result<void> M3PassContext::recordImageUpload(
    VkImage image,
